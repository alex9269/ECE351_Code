...
# =============================================================================
# numpy.real()    # returns the real part of the complex number
# numpy.imag()    # returns the imaginary part of the complex number (excluding the j)
# abs()           # returns the magnitude of the complex number
#                 # (this is native to Python; numpy is not needed)
# numpy.angle()   # returns the angle (in radians) of the complex number
# =============================================================================
...
# np.arange()         # create a numpy array that is a range of numbers with a defined
#                     # step size
